 ...
 *
 */
public class SuyCallBackMsg {
	/**
	 * 登录返回消息
	 */
	public final static int LOGIN_RESULT = 100;	
	/**
	 * 注销返回消息
	 */
	public final static int LOGOUT_RESULT = 101;
	 ...
	 * 被踢下线消息
	 */
	public final static int KICK_MSG = 110;
	 ...
	 * 上传照片
	 */
	public final static int UPLOADPHOTO_RESULT = 126;


	/**
	 * 改变在线状态返回消息
	 */
	public final static int CHANGE_STATUS_RESULT = 125;
