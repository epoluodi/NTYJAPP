 ...
 */
public class Right extends BaseTask {

    public static final int GETApproveUsers = 0;
    private InterfaceTask interfaceTask;
    private int tasktype;

    public Right(InterfaceTask interfaceTask, int tasktype) {
        super();
    ...
    void queryApproveUsers() {

        String url;
        try {
            //登录成功后，需要启动消息轮询机制
            Looper.prepare();
            url = String.format("%1$suser/queryApproveUsers",
