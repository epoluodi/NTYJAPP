...
/**
 * Created by Stereo on 16/3/24.
 */
public class ListForRefresh extends ListView implements AbsListView.OnScrollListener {
    ...
    public ListForRefresh(Context context) {
        super(context);
        init(context);
    }

    public ListForRefresh(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }
    ...
    private void init(Context context) {
        ...
        headerView = (LinearLayout) inflater.inflate(R.layout.scrollviewwithlist, null);
        ...
        // 设置下拉刷新图标的最小高度和宽度
//        lvHeaderArrowIv.setMinimumWidth(LinearLayout.LayoutParams.MATCH_PARENT);
    ...
    private void changeHeaderViewByState() {
        switch (state) {
            ...
            case DONE:
                ...
                lvHeaderProgressBar.setVisibility(View.GONE);
                lvHeaderArrowIv.clearAnimation();
                lvHeaderArrowIv.setImageResource(R.drawable.refreshmark_icon);
                lvHeaderTipsTv.setText("下拉刷新");
                lvHeaderLastUpdatedTv.setVisibility(View.VISIBLE);
                break;
        }
