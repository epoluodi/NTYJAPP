...
import com.suypower.pms.view.plugin.scan.camera.CameraManager;
import com.suypower.pms.view.plugin.scan.decoding.CaptureActivityHandler;
import com.suypower.pms.view.plugin.scan.decoding.InactivityTimer;
import com.suypower.pms.view.plugin.scan.view.ViewfinderView;
...
//                imageViewline.setBackgroundColor(getResources().getColor(R.color.red));
                imageViewline.setBackground(getResources().getDrawable(R.drawable.scanline));
