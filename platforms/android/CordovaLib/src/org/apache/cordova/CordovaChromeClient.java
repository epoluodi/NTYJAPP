...
public class CordovaChromeClient extends WebChromeClient {
    ...
    public boolean onJsAlert(WebView view, String url, String message, final JsResult result) {
        ...
        final AlertDlg alertDlg = new AlertDlg(this.cordova.getActivity(), AlertDlg.AlertEnum.ALTERTYPE);
        alertDlg.setContentText(message);
...
//        lastHandledDialog = dlg.show();
    ...
    {
        Log.i("onJsConfirm url",url);
        final AlertDlg alertDlg = new AlertDlg(this.cordova.getActivity(),
                AlertDlg.AlertEnum.TIPS);
        alertDlg.setContentText(message);
        alertDlg.setOkClickLiseter(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
